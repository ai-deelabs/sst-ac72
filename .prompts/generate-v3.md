...
Brand:
SST is a life insurance website. The style is professional and trustworthy.

This is variant 3 of 3.

CREATIVE DIRECTION
A creative director has chosen this direction for variant #3:
Horizontal scroll sections with pinned sticky nav, oversized numerals as decorative scaffolding, data-forward layout — Extended grotesque with variable-width optical sizing, monospace numerals inline with prose — Dark mode vivid editorial: #0A0A0F near-void background, #F0F0FF ghosted lavender-white body, #7C3AFF electric violet #7C3AFF primary, #00E5C3 bioluminescent teal #00E5C3 accent, #FF3D6B signal coral #FF3D6B for urgency indicators — Minority Report control room meets actuarial precision, high-stakes and kinetic
