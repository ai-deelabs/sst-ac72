...
Asymmetric split-screen grid with full-bleed photography left, text columns right at 60/40 — Condensed grotesque headlines (400+ tracking) paired with light weight body copy — Monochromatic slate: #0D1B2A deep navy-black canvas, #1E3A5F mid-slate, #4A7FA5 steel blue, #C8DCF0 ice highlight, #FFFFFF text — Cold Scandinavian modernism, still and authoritative
